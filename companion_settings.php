	...
	<?php
		...
		if(isset($_POST['submit'])) {
			if(!isset($_POST['email']) || trim($_POST['email']) == '') {
				...
				$wpdb->query("UPDATE $table_name SET mail='$_POST[email]', sccsmsg='$_POST[succesmsg]', failmsg='$_POST[failmsg]', navtab='$_POST[navtab]', bottom='$_POST[bottom]', steps='$_POST[steps]', progress='$_POST[progress]' WHERE id = '1'")or die(mysql_error());
			}
		}
	...
	<form method="post" action="<?php $_SERVER['REQUEST_URI']; ?>">
		<div id="welcome-panel" class="welcome-panel">
			...
			<div style='width: 48%; float: left; margin: 1%;'>
				<b style="text-transform: uppercase;">Messages &amp; Info</b> <i style="color: #424242;"> basic info &amp; messages</i><br>
				<table>
					<tr>
						<td width="200">
							<b>To:</b>
			...
			<div style='width: 48%; float: left; margin: 1%;'>
				<b style="text-transform: uppercase;">Turn On/Off</b> <i style="color: #424242;"> turn features on/off</i><br>
				<table>
					<tr>
						<td width="200">
							<b>Navigation Tabs:</b>
					...
					<tr>
						...
						<td width="200">
							<select name="progress" style="width: 100%;">
								<option value="<?=$progress; ?>">Currently: <?=$currentprogress; ?></option>
								<option value="0">Show</option>
								<option value="1">Hide</option>
							</select>
						</td>
